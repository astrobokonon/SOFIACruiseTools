...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayout_2.addWidget(self.flight_map_plot, 1, 0, 1, 1)
        self.flight_plan_label = QtWidgets.QLabel(Dialog)
        self.flight_plan_label.setAlignment(QtCore.Qt.AlignCenter)
        self.flight_plan_label.setObjectName("flight_plan_label")
        self.gridLayout_2.addWidget(self.flight_plan_label, 0, 0, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.flight_plan_label.setText(_translate("Dialog", "TextLabel"))
