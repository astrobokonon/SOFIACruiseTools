...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.buttonBox.setGeometry(QtCore.QRect(280, 440, 171, 32))
        ...
        self.datalocText.setGeometry(QtCore.QRect(340, 290, 241, 41))
        ...
        self.datalocText.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        self.datalocText.setWordWrap(True)
        self.datalocText.setObjectName("datalocText")
        self.flightText = QtWidgets.QLabel(Dialog)
        self.flightText.setGeometry(QtCore.QRect(340, 110, 251, 41))
        self.flightText.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignTop)
        self.flightText.setWordWrap(True)
        ...
        self.test_config.setGeometry(QtCore.QRect(60, 490, 85, 21))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.appendLogCheck.setText(_translate("Dialog", "Append to existing log"))
        self.appendDataCheck.setText(_translate("Dialog", "Append to existing data log"))
