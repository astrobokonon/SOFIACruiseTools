...
class SOFIACruiseDirectorApp(QtWidgets.QMainWindow, scdp.Ui_MainWindow):
    def __init__(self):
        ...
        self.log_quick_fault_mccs.clicked.connect(self.mark_fault_mccs)
        self.log_quick_fault_si.clicked.connect(self.mark_fault_si)
        self.log_quick_landing.clicked.connect(self.mark_landing)
        self.log_quick_on_heading.clicked.connect(self.mark_on_heading)
        self.log_quick_on_target.clicked.connect(self.mark_on_target)
...
#        del window
    ...
    def select_dir(self):
        '''
        Opens a window to allow the user to select the directory where data is 
        being stored. Called when the "Set Data Directory" button on the Data Log
        tab is pressed.
        ...
        self.data_log_dir = QtWidgets.QFileDialog.getExistingDirectory(self, dtxt)
    ...
    def select_output_file(self):
        ...
        Spawn the file chooser diaglog box and return the result, attempting
        to both open and write to the file.
        Called when the "Choose Output Filename" button on the Cruise Director 
        Log tab is pressed.
        """
    ...
    def select_log_output_file(self):
        ...
        Spawn the file chooser diaglog box and return the result, attempting
        to both open and write to the file.
        Called when the "Set Log Output File" button on the Data Log tab is 
        pressed.
        """
    ...
    def post_log_line(self):
        '''
        Writes a custom line to the Cruise Director Log by calling log_input_line
        Records whatever is in the text box at the bottom of the Cruise Director
        Log tab to the log file when the "Post" Button is pressed.
        '''
    ...
    def count_remaining(self):
        '''
        Toggles the display mode of the leg timer to display the time remaining
        for this leg. Called when the "Time Remaining" button in the Leg Timers
        pane is selected. 
        Sets:
            doLegCountElapsed
            doLegCountRemaining
    ...
    def count_elapsed(self):
        '''
        Toggles the display mode of the leg timer to display the time elapsed
        for this leg. Called when the "Time Elapsed" button in the Leg Timers
        pane is selected. 
        Sets:
            doLegCountElapsed
            doLegCountRemaining
    ...
    def start_leg_timer(self):
        ...
        Called when the "Start" button in the Leg Timers pane is selected
        Sets:
            leg_counting
            timer_start_time
            timer_end_time
    ...
    def stop_leg_timer(self):
        '''
        Stops the leg timer by altering flags.
        Called when the "Stop" button in the Leg Timers pane is selected.
        Sets:
            leg_counting
            leg_counting_stopped
        '''
    ...
    def reset_leg_timer(self):
        '''
        Resets the leg timer and starts counting if the counting is 
        currently stopped.
        Called when the "Reset" button in the Leg Timers pane is selected.
        Sets:
            leg_counting
            timer_start_time
            timer_end_time
    ...
    def set_takeoff_and_landing(self):
        '''
        This function starts the MET and TTL timers. 
        It is called when the "Start Both" button in the "Current Flight
    ...
    def update_times(self):
        ...
        Called during initialization of the app and at the beginning of every 
        showlcd loop.
        Sets:
    ...
    def show_lcd(self):
        ...
        if self.leg_counting is True:
            ...
            # Only runs if the "Start" button in the "Leg Timer" panel is pressed
            local2 = self.local_now.replace(tzinfo=None)
            ...
            if self.do_leg_count_remaining is True:
                # Formats to Leg Timer to show how much time is remaining until 
                # the leg ends
                # The timer is color-coded based on how long this time is:
            ...
            if self.do_leg_count_elapsed is True:
                ...
                self.leg_elapsed_str = self.total_sec_to_hms_str(self.leg_elapsed)
...
#                print self.datatable
    ...
    def add_data_log_row(self):
        ...
        Called when the "Add Blanck Row" button in the Data Log tab is pressed.
    ...
    def repopulate_data_log(self, rescan=False):
        ...
        self.table_data_log.horizontalHeader().setDragDropMode(QtWidgets.QAbstractItemView.NoDragDrop)
...
#        self.table_datalog.setSortingEnabled(True)
        ...
        self.table_data_log.horizontalHeader().setDragDropMode(QtWidgets.QAbstractItemView.InternalMove)
    ...
    def update_data_log(self):
        ...
        Called when either the "Force Update" button in the Data Log tab is
        pressed or at the end of the showlcd loop if the "Autoupdate every:"
        option is selected. 
...
#            self.table_datalog.setSortingEnabled(True)
    ...
    def update_leg_info_window(self):
        ...
        if self.success_parse is True:
            ...
            time_parts = str(self.leg_info.duration)
