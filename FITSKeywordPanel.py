...
class Ui_FITSKWDialog(object):
    def setupUi(self, FITSKWDialog):
        ...
        self.buttonsApplyCancel = QtGui.QDialogButtonBox(FITSKWDialog)
        ...
        self.buttonMoveup = QtGui.QPushButton(FITSKWDialog)
        ...
        self.keywordListwidget = QtGui.QListWidget(FITSKWDialog)
        font = QtGui.QFont()
        ...
        QtCore.QObject.connect(self.buttonsApplyCancel, QtCore.SIGNAL(_fromUtf8("accepted()")), FITSKWDialog.accept)
        QtCore.QObject.connect(self.buttonsApplyCancel, QtCore.SIGNAL(_fromUtf8("rejected()")), FITSKWDialog.reject)
    ...
    def retranslateUi(self, FITSKWDialog):
        ...
        self.buttonAdd.setText(_translate("FITSKWDialog", "Add Keyword", None))
        self.buttonMovedown.setText(_translate("FITSKWDialog", "Move Down", None))
        self.buttonRemove.setText(_translate("FITSKWDialog", "Remove Keyword", None))
        self.labelHDUchoosen.setText(_translate("FITSKWDialog", "HDU to Search for Keywords (0 indexed)", None))
        self.buttonMoveup.setText(_translate("FITSKWDialog", "Move Up", None))
        ...
        self.buttonLoad.setText(_translate("FITSKWDialog", "Load List ...", None))
        self.buttonSave.setText(_translate("FITSKWDialog", "Save List ...", None))
