    ...
    for idx in legidx:
        ...
        if leg.legtype is 'Observing':
            ...
            if "orbital" in leg.target:
                ...
                partial = (contents[idx+4].split('Angle:')[1].strip()).split()
                leg.moonangle = np.int(partial[0].strip())
